<?php
$access_token = 'kZAiDdNIb0C8PyVSJEv4GDmBSXDOQpuKDO05H9GgvsWseLE2kArZO0WI6U9y2qs9/OK6bFBiGVVrsMTY1fH/4fCK8l7Ix3767gb24gjUZCAwRVsGAyw1VKTF6UwRh6UXFofCUivP/2G1wzPuPfjugAdB04t89/1O/w1cDnyilFU=';
...
[help] to view the menu"
			...
			if (ereg_replace('[[:space:]]+', '', trim($text)) == "10"){
			   ...
			   if (ereg_replace('[[:space:]]+', '', strtoupper($text)) == "MAP14"){
				...
				'type' => 'location',
				'title'=> ' อ.เมือง จ.ตรัง  Muang Trang',
                		'address'=> 'ศาลเจ้าท่ามกงเยีย  Tam Kong Yaer Harbor Shrine',
                		'latitude'=> 7.566338,
               			 'longitude'=> 99.615475
			];
			}
			   if (ereg_replace('[[:space:]]+', '', strtoupper($text)) == "MAP18"){
				...
				'type' => 'location',
				'title'=>  ' อ.เมือง จ.ตรัง   Muang Trang',
                		'address'=> 'พระโพธิสัตว์กวนอิม  Quan Yin Bodhisattva',
                		'latitude'=> 7.555249,
               			 'longitude'=> 99.601392
			];
			}
			   if (ereg_replace('[[:space:]]+', '', strtoupper($text)) == "MAP19"){
				...
				'type' => 'location',
				'title'=> ' อ.เมือง จ.ตรัง  Muang Trang',
                		'address'=> 'สวนสมเด็จพระศรีนครินทร์  Trang Holiday Park',
                		'latitude'=> 7.571334,
               			 'longitude'=> 99.598054
			];
			}
			   if (ereg_replace('[[:space:]]+', '', strtoupper($text)) == "MAP17"){
				...
				'type' => 'location',
				'title'=>' อ.เมือง จ.ตรัง  Muang Trang',
                		'address'=> 'คริสตจักรตรัง  Trang Church',
                		'latitude'=> 7.559037,
               			 'longitude'=> 99.604995
			];
			}
			   if (ereg_replace('[[:space:]]+', '', strtoupper($text)) == "MAP16"){
				...
				'type' => 'location',
				'title'=> ' อ.เมือง จ.ตรัง  Muang Trang',
                		'address'=> 'สระกะพังสุรินทร์  Krapang basin',
                		'latitude'=> 7.575515,
               			 'longitude'=> 99.626205
			];
			}
			   if (ereg_replace('[[:space:]]+', '', strtoupper($text)) == "MAP15"){
				...
				'type' => 'location',
				'title'=> ' อ.เมือง จ.ตรัง  Muang Trang',
                		'address'=> 'อนุสาวรีย์พระยารัษฎานุประดิษฐ์มหิศรภักดี  Phaya Radsada Monument of History',
                		'latitude'=> 7.564244,
               			 'longitude'=> 99.622264
			];
			}
			   if (ereg_replace('[[:space:]]+', '', strtoupper($text)) == "MAP13"){
				...
				'type' => 'location',
				'title'=>  ' อ.เมือง จ.ตรัง  Muang Trang',
                		'address'=> 'จวนผู้ว่าราชการ  Trang Governor',
                		'latitude'=> 7.561319,
               			 'longitude'=> 99.612805
			];
			}
			   if (ereg_replace('[[:space:]]+', '', strtoupper($text)) == "MAP12"){
				...
				'type' => 'location',
				'title'=>  ' อ.เมือง จ.ตรัง  Muang Trang',
                		'address'=> 'วงเวียนพะยูน  Payoon Circus',
                		'latitude'=> 7.560035,
               			 'longitude'=> 99.611964
			];
			}
			   ...
			   if (ereg_replace('[[:space:]]+', '', strtoupper($text)) == "MAP25"){
				$messages = [
				'type' => 'location',
				'title'=> 'อ.นาโยง จ.ตรัง  Nayong Trang',
                		'address'=> 'น้ำตกกระช่อง  Krachong waterfall',
                		'latitude'=> 7.548825,
               			 'longitude'=> 99.786980
			];
			}
			   if (ereg_replace('[[:space:]]+', '', strtoupper($text)) == "MAP24"){
				...
				'type' => 'location',
				'title'=> 'อ.นาโยง จ.ตรัง  Nayong Trang',
                		'address'=> 'ถ้ำเขาช้างหาย  khao chang hai cave',
                		'latitude'=> 7.589745,
               			 'longitude'=> 99.667212
			];
			}
			   if (ereg_replace('[[:space:]]+', '', strtoupper($text)) == "MAP26"){
				...
				'type' => 'location',
				'title'=> 'อ.นาโยง จ.ตรัง  Nayong Trang',
                		'address'=> 'อุทยานนกน้ำคลองลำซาน  Clong lum san park',
                		'latitude'=> 7.500198,
               			 'longitude'=> 99.777386
			];
			}
			   if (ereg_replace('[[:space:]]+', '', strtoupper($text)) == "MAP23"){
				...
				'type' => 'location',
				'title'=> 'อ.นาโยง จ.ตรัง  Nayong Trang',
                		'address'=> 'กลุ่มทอผ้านาหมื่นศรี  Nameunsri Weaving Group',
                		'latitude'=> 7.599657,
               			 'longitude'=> 99.688582
			];
			}
			   if (ereg_replace('[[:space:]]+', '', strtoupper($text)) == "MAP22"){
				...
				'type' => 'location',
				'title'=> 'อ.นาโยง จ.ตรัง  Nayong Trang',
                		'address'=> 'วัดปากเหมือง  Pak meung tample ',
                		'latitude'=> 7.557658,
               			 'longitude'=> 99.694503
			];
			}
			   if (ereg_replace('[[:space:]]+', '', strtoupper($text)) == "MAP27"){
				$messages = [
				'type' => 'location',
				'title'=> 'อ.ย่านตาขาว จ.ตรัง  Yantakhao Trang',
                		'address'=> 'น้ําตกไพรสวรรค์  Prisawan waterfall',
                		'latitude'=> 7.412434,
               			 'longitude'=> 99.826717
			];
			}
			   ...
			   if (ereg_replace('[[:space:]]+', '', strtoupper($text)) == "MAP32"){
				...
				'type' => 'location',
				'title'=>  'อ.ย่านตาขาว จ.ตรัง  Yantakhao Trang',
                		'address'=> 'สวนพฤกษศาสตร์ภาคใต้(ทุ่งค่าย)  Southern botanical garden',
                		'latitude'=> 7.468389,
               			 'longitude'=> 99.635796
			];
			}
			   if (ereg_replace('[[:space:]]+', '', strtoupper($text)) == "MAP37"){
				...
				'type' => 'location',
				'title'=>  'อ.ย่านตาขาว จ.ตรัง  Yantakhao Trang',
                		'address'=> 'น้ำตกสายรุ้ง  Sairung waterfall',
                		'latitude'=> 7.440224,
               			 'longitude'=> 99.814039
			];
			}
			   if (ereg_replace('[[:space:]]+', '', strtoupper($text)) == "MAP33"){
				...
				'type' => 'location',
				'title'=>'อ.ย่านตาขาว จ.ตรัง  Yantakhao Trang',
                		'address'=> 'น้ำตกน้ำเค็ม  Namkem waterfall',
                		'latitude'=> 7.442214,
               			 'longitude'=> 99.619308
			];
			}
			   ...
			   if (ereg_replace('[[:space:]]+', '', strtoupper($text)) == "MAP35"){
				...
				'type' => 'location',
				'title'=> 'อ.ย่านตาขาว จ.ตรัง  Yantakhao Trang',
                		'address'=> 'น้ำตกลำปลอก  Lumplok waterfall',
                		'latitude'=> 7.370002,
               			 'longitude'=> 99.823304
			];
			}
			   if (ereg_replace('[[:space:]]+', '', strtoupper($text)) == "MAP34"){
				...
				'type' => 'location',
				'title'=> 'อ.ย่านตาขาว จ.ตรัง  Yantakhao Trang',
                		'address'=> 'ศาลพระร้อยเก้า  Roi Kao Shrine',
                		'latitude'=> 7.375451,
               			 'longitude'=> 99.675159
			];
			}
			   ...
			   if (ereg_replace('[[:space:]]+', '', strtoupper($text)) == "MAP43"){
				$messages = [
				'type' => 'location',
				'title'=> 'อ.ปะเหลียน จ.ตรัง  Phalean Trang',
                		'address'=> 'น้ำตกโตนเต๊ะ  Tontae waterfall',
                		'latitude'=> 7.2944939,
			   ...
			   if (ereg_replace('[[:space:]]+', '', strtoupper($text)) == "MAP44"){
				...
				'type' => 'location',
				'title'=>'อ.ปะเหลียน จ.ตรัง  Phalean Trang',
                		'address'=> 'น้ำตกโตนตก  Tontok waterfall',
                		'latitude'=> 7.2759846,
			   ...
			   if (ereg_replace('[[:space:]]+', '', strtoupper($text)) == "MAP42"){
				...
				'type' => 'location',
				'title'=> 'อ.ปะเหลียน จ.ตรัง  Phalean Trang',
                		'address'=> 'น้ำตกช่องบรรพต  Chongbanpot waterfall',
                		'latitude'=> 7.282881,
               			 'longitude'=> 99.813623
			];
			}
			   if (ereg_replace('[[:space:]]+', '', strtoupper($text)) == "MAP47"){
				...
				'type' => 'location',
				'title'=> 'อ.ปะเหลียน จ.ตรัง   Phalean Trang',
                		'address'=> 'แหลมหยงสตาร์  Youngstar peaked',
                		'latitude'=> 7.115333,
               			 'longitude'=> 99.667700
			];
			}
			   if (ereg_replace('[[:space:]]+', '', strtoupper($text)) == "MAP46"){
				$messages = [
				'type' => 'location',
				'title'=> 'อ.ปะเหลียน จ.ตรัง  Palean Trang',
                		'address'=> 'น้ำตกธารกระจาย  Tangrajai waterfall',
                		'latitude'=> 7.169977,
               			 'longitude'=> 99.818179
			];
			}
			   if (ereg_replace('[[:space:]]+', '', strtoupper($text)) == "MAP45"){
				...
				'type' => 'location',
				'title'=> 'อ.ปะเหลียน จ.ตรัง  Palean Trang',
                		'address'=> 'ถ้ำเขาติง  Khaoting cave',
                		'latitude'=> 7.158202,
               			 'longitude'=> 99.801873
			];
			}
			   ...
			   if (ereg_replace('[[:space:]]+', '', strtoupper($text)) == "MAP52"){
				$messages = [
				'type' => 'location',
				'title'=> 'อ.หาดสำราญ จ.ตรัง  Hadsumran',
                		'address'=> 'วัดปากปรน  Pakpron temple',
                		'latitude'=> 7.266234,
               			 'longitude'=> 99.545218
			];
			}
			   if (ereg_replace('[[:space:]]+', '', strtoupper($text)) == "MAP53"){
				$messages = [
				'type' => 'location',
				'title'=> 'อ.หาดสำราญ จ.ตรัง  Hasumran',
                		'address'=> 'ท่าเรือปากปรน  Pakpron port',
                		'latitude'=> 7.270704,
               			 'longitude'=> 99.538346
			];
			}
			   if (ereg_replace('[[:space:]]+', '', strtoupper($text)) == "MAP65"){
				$messages = [
				'type' => 'location',
				'title'=> 'อ.กันตัง จ.ตรัง  Kantang Trang',
                		'address'=> 'วนอุทยานน้ำพุร้อนควนแดง Kuandang Hot spring park',
                		'latitude'=> 7.409409,
               			 'longitude'=> 99.463213
			];
			}
			   if (ereg_replace('[[:space:]]+', '', strtoupper($text)) == "MAP62"){
				$messages = [
				'type' => 'location',
				'title'=>'อ.กันตัง จ.ตรัง  Katang Trang',
                		'address'=> 'บ้านพระยารัษฎานุประดิษฐ์ Radsada Museum',
                		'latitude'=> 7.407587,
               			 'longitude'=> 99.515416
			];
			}
			   if (ereg_replace('[[:space:]]+', '', strtoupper($text)) == "MAP64"){
				...
				'type' => 'location',
				'title'=> 'อ.กันตัง จ.ตรัง  Kantang Trang',
                		'address'=> 'ต้นยางพาราต้นแรก  The first Rubber',
                		'latitude'=> 7.409590,
               			 'longitude'=> 99.522842
			];
			}
			   ...
			   if (ereg_replace('[[:space:]]+', '', strtoupper($text)) == "MAP66"){
				...
				'type' => 'location',
				'title'=>'อ.กันตัง จ.ตรัง  Kantang Trang',
                		'address'=> 'หาดหยงหลิง  Yongling beach',
                		'latitude'=> 7.340928,
               			 'longitude'=> 99.373399
			];
			}
			   if (ereg_replace('[[:space:]]+', '', strtoupper($text)) == "MAP63"){
				...
				'type' => 'location',
				'title'=> 'อ.กันตัง จ.ตรัง  Kantang Trang',
                		'address'=> 'สถานีรถไฟกันตัง  Kantang train station',
                		'latitude'=> 7.410813,
               			 'longitude'=> 99.514646
			];
			}
			   if (ereg_replace('[[:space:]]+', '', strtoupper($text)) == "MAP61"){
				...
				'type' => 'location',
				'title'=> 'อ.กันตัง จ.ตรัง  Kantang Trang',
                		'address'=> 'ควนตําหนักจันทน์  Jun palace ',
                		'latitude'=> 7.405329,
               			 'longitude'=> 99.520313
			];
			}
			   ...
			   if (ereg_replace('[[:space:]]+', '', strtoupper($text)) == "MAP73"){
				$messages = [
				'type' => 'location',
				'title'=> 'อ.สิเกา จ.ตรัง  Sigao Trang',
                		'address'=> 'หาดปากเมง  Pak meng beach',
                		'latitude'=> 7.490606,
               			 'longitude'=> 99.329417
			];
			}
			   if (ereg_replace('[[:space:]]+', '', strtoupper($text)) == "MAP72"){
				...
				'type' => 'location',
				'title'=>'อ.สิเกา จ.ตรัง  Sigao Trang',
                		'address'=> 'อุทยานแห่งชาติหาดเจ้าไหม  Jao mai national park',
                		'latitude'=> 7.412056,
               			 'longitude'=> 99.345359 
			];
			}
			   if (ereg_replace('[[:space:]]+', '', strtoupper($text)) == "MAP74"){
				...
				'type' => 'location',
				'title'=> 'อ.สิเกา จ.ตรัง  Sigao Trang',
                		'address'=> 'พิพิธภัณฑ์สัตว์น้ำราชมงคล   Radchamongkol Aquarium' ,
                		'latitude'=> 7.529688,
               			 'longitude'=> 99.309753
			];
			}
			   if (ereg_replace('[[:space:]]+', '', strtoupper($text)) == "MAP75"){
				...
				'type' => 'location',
				'title'=> 'อ.สิเกา จ.ตรัง  Sigao Trang',
                		'address'=> 'หาดราชมงคล  Radchamongkol beach',
                		'latitude'=> 7.528221,
               			 'longitude'=> 99.307916
			];
			}
			   if (ereg_replace('[[:space:]]+', '', strtoupper($text)) == "MAP76"){
				...
				'type' => 'location',
				'title'=>'อ.สิเกา จ.ตรัง  Sigao Trang',
                		'address'=> 'วัดเขาไม้แก้ว  khaomaikeaw temple',
                		'latitude'=> 7.638053,
               			 'longitude'=> 99.321923
			];
			}
			   ...
			   if (ereg_replace('[[:space:]]+', '', strtoupper($text)) == "MAP83"){
				$messages = [
				'type' => 'location',
				'title'=> 'อ.วังวิเศษ จ.ตรัง  Wangwiset District',
                		'address'=> 'วังผาเมฆ  Wang pha mek ',
                		'latitude'=> 7.650992,
               			 'longitude'=> 99.363781
			];
			}
			   if (ereg_replace('[[:space:]]+', '', strtoupper($text)) == "MAP82"){
				...
				'type' => 'location',
				'title'=>'อ.วังวิเศษ จ.ตรัง  Wangwiset District',
                		'address'=> 'สวนสาธารณะวังนกน้ำ  Wang nok nam Park',
                		'latitude'=> 7.643963,
               			 'longitude'=> 99.481688
			];
			}
			   if (ereg_replace('[[:space:]]+', '', strtoupper($text)) == "MAP85"){
				...
				'type' => 'location',
				'title'=> 'อ.วังวิเศษ จ.ตรัง  Wangwiset District',
                		'address'=> 'น้ําตกร้อยชั้นพันวัง  Roi chan pun wang waterfall',
                		'latitude'=> 7.895146,
               			 'longitude'=> 99.317788
			];
			}
			   if (ereg_replace('[[:space:]]+', '', strtoupper($text)) == "MAP84"){
				...
				'type' => 'location',
				'title'=> 'อ.วังวิเศษ จ.ตรัง  Wangwiset District',
                		'address'=> 'วัดราษฎร์รังสรรค์  Rad rung shun temple',
                		'latitude'=> 7.747697,
               			 'longitude'=> 99.389275
			];
			}
			   ...
			   if (ereg_replace('[[:space:]]+', '', strtoupper($text)) == "MAP96"){
				$messages = [
				'type' => 'location',
				'title'=> 'อ.ห้วยยอด จ.ตรัง  Huaiyot District',
                		'address'=> 'ถ้ำเลเขากอบ  Khao gob cave',
                		'latitude'=> 7.794298,
               			 'longitude'=> 99.572331
			];
			}
			   if (ereg_replace('[[:space:]]+', '', strtoupper($text)) == "MAP95"){
				...
				'type' => 'location',
				'title'=> 'อ.ห้วยยอด จ.ตรัง  Huaiyot District',
                		'address'=> 'เขาหัวแตก  Hua teag Mountain',
                		'latitude'=> 7.800276,
               			 'longitude'=> 99.580905
			];
			}
			   if (ereg_replace('[[:space:]]+', '', strtoupper($text)) == "MAP97"){
				...
				'type' => 'location',
				'title'=> 'อ.ห้วยยอด จ.ตรัง  Huaiyot District',
                		'address'=> 'วังเทพทาโร  Wang Thep Taro',
                		'latitude'=> 7.806683,
               			 'longitude'=> 99.571657
			];
			   if (ereg_replace('[[:space:]]+', '', strtoupper($text)) == "MAP93"){
				...
				'type' => 'location',
				'title'=> 'อ.ห้วยยอด จ.ตรัง  Huaiyot District',
                		'address'=> 'ศูนย์ศิลปะวิถี  Art Way Gallery',
                		'latitude'=> 7.715549,
               			 'longitude'=> 99.664868
			];
			}
			   if (ereg_replace('[[:space:]]+', '', strtoupper($text)) == "MAP94"){
				...
				'type' => 'location',
				'title'=> 'อ.ห้วยยอด จ.ตรัง  Huaiyot District',
                		'address'=> 'น้ำตกปากแจ่ม  Pak jame waterfall',
                		'latitude'=> 7.748637,
               			 'longitude'=> 99.695031
			];
			}
			   if (ereg_replace('[[:space:]]+', '', strtoupper($text)) == "MAP92"){
				...
				'type' => 'location',
				'title'=>'อ.ห้วยยอด จ.ตรัง  Huaiyot District',
                		'address'=> 'เขาน้ำพราย  Nam prie Mountain' ,
                		'latitude'=> 7.715560,
               			 'longitude'=> 99.616667
			];
			}
			   if (ereg_replace('[[:space:]]+', '', strtoupper($text)) == "MAP98"){
				...
				'type' => 'location',
				'title'=> 'อ.ห้วยยอด จ.ตรัง  Huaiyot District',
                		'address'=> 'ถ้ำเขาปินะ  Pi na mountain cave',
                		'latitude'=> 7.749365,
               			 'longitude'=> 99.527385
			];
			}
			   ...
			   if (ereg_replace('[[:space:]]+', '', strtoupper($text)) == "MAP103"){
				$messages = [
				'type' => 'location',
				'title'=> 'อ.รัษฎา จ.ตรัง  Rassada Trang' ,
                		'address'=> 'วัดถํ้าพระพุทธ  tum pra put temple',
                		'latitude'=> 7.966571,
               			 'longitude'=> 99.744980
			];
			}
			   if (ereg_replace('[[:space:]]+', '', strtoupper($text)) == "MAP102"){
				...
				'type' => 'location',
				'title'=> 'อ.รัษฎา จ.ตรัง  Rassada Trang' ,
                		'address'=> 'ถ้ำพระยาพิชัยสงคราม  Prayapichaishongkram cave',
                		'latitude'=> 8.007172,
               			 'longitude'=> 99.751283
			];
			}
			   if (ereg_replace('[[:space:]]+', '', strtoupper($text)) == "MAP101"){
				...
				'type' => 'location',
				'title'=> 'อ.รัษฎา จ.ตรัง  Rassada Trang' ,
                		'address'=> 'วัดคลองเขาจันทร์  Clongkhaochan temple',
                		'latitude'=> 7.918779,
               			 'longitude'=> 99.692320
			];
			}
			   if (ereg_replace('[[:space:]]+', '', strtoupper($text)) == "MAP111"){
				...
				'type' => 'location',
				'title'=> 'อ.เมือง จ.ตรัง Muang Trang',
                		'address'=> 'ร้านแกงส้ม  Khang som restaurant' ,
                		'latitude'=> 7.559810,
               			 'longitude'=> 99.607043
			];
			}
			   if (ereg_replace('[[:space:]]+', '', strtoupper($text)) == "MAP122"){
				...
				'type' => 'location',
				'title'=> 'อ.เมือง จ.ตรัง  Muang Trang',
                		'address'=> 'เค้กรสเลิศ  rodlert cake',
                		'latitude'=> 7.555034,
               			 'longitude'=> 99.604646
			];
			}
